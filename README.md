...
| 姓名 | 角色 | 主要职责 |
|------|------|----------|
| 慕悦 | Scrum Master / 后端开发 | 项目进度把控、后端模块开发、数据库设计 |
| 李慧 | 技术负责人 / 后端开发 | 架构设计、关键技术难题攻关、后端模块开发 |
| 葛一凡 | 后端开发 | 后端开发、API 联调 |
| 许祎诺 | 前端开发 | 前端开发、UI 设计 |
| 马睿 | 前端开发 | 前端开发、UI 设计 |
...
| 迭代 | 时间 | 目标 |
|------|------|------|
| 迭代一：基础架构搭建 | 9月4日—9月9日（6天） | 建立项目基础框架，完成实体类、接口设计及测试用例设计 |
| 迭代二：核心功能实现 | 9月10日—9月17日（8天） | 完成核心业务功能开发与功能测试 |
| 迭代三：完善与交付 | 9月18日—9月25日（8天） | 功能优化、系统测试（性能/安全）、总结报告与文档归档 |

协作工具：TAPD（任务看板与文档）、GitHub（代码管理）、微信群（即时通讯）
